package com.joonsoft.joonengine.renderer.texture;
...
public class TextureLoader {
	 ...
	 */
	public Texture getTexture(String resourceName, boolean clamp) throws IOException {
	 ...
	 *             Indicates a failure to access the resource
	 */
	public Texture getTexture(String resourceName, int target, int dstPixelFormat, int minFilter, int magFilter, boolean clamp) throws IOException {
		int srcPixelFormat;
